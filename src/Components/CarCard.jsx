...
const CarCard = ({car,index}) => {
    ...
    return (
          <motion.div
            ...
            className="bg-zinc-800/80 border border-zinc-700 hover:border-yellow-500 hover:shadow-yellow-500/20 hover:shadow-md rounded-2xl transition-all duration-300 overflow-hidden backdrop-blur-sm relative"
          >
            ...
            <div className="p-5">
              ...
              <p className="text-gray-400 text-sm mb-2">Provider: {car.providerName}</p>
              <p className="text-lg font-bold text-green-400 mb-4">৳{car.rentPricePerDay} / day</p>
